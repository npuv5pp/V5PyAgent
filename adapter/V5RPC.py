...
class Transfer:
    ...
    def server_routine(self, protobuf_msg):
        ...
        if case == "on_event":
            v5strategy.on_event(self.call.on_event.type, self.call.on_event.arguments)
            ...
            team_info_result = proto.API_pb2.GetTeamInfoResult()  # 新建结构体
            ...
            wheel, control_info = v5strategy.get_instruction(self.call.get_instruction.field)
            instruction_result = proto.API_pb2.GetInstructionResult()
            ...
            placement = v5strategy.get_placement(self.call.get_placement.field)  # v5strategy函数中控制的placement
            placement_result = proto.API_pb2.GetPlacementResult()
